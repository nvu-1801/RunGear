...
export async function GET(
  ...
  try {
    ...
    // ✅ FIX: Add "ORD" prefix if not present
    const orderCode = id.startsWith("ORD") ? id : `ORD${id}`;
    console.log("[GET /api/orders/[id]] Normalized orderCode:", orderCode);
    ...
    const { data, error } = await supabase
      ...
      .eq("order_code", orderCode) // ✅ Query by UUID
